...
```
select:mcp__plugin_ancora_ancora__mem_save,mcp__plugin_ancora_ancora__mem_search,mcp__plugin_ancora_ancora__mem_context,mcp__plugin_ancora_ancora__mem_session_summary,mcp__plugin_ancora_ancora__mem_get_observation,mcp__plugin_ancora_ancora__mem_suggest_topic_key,mcp__plugin_ancora_ancora__mem_update,mcp__plugin_ancora_ancora__mem_session_start,mcp__plugin_ancora_ancora__mem_session_end,mcp__plugin_ancora_ancora__mem_save_prompt
```
