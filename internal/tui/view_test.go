...
func TestRenderObservationListItem(t *testing.T) {
	...
	if !strings.Contains(line, "ancora") {
...
func TestViewMoveObservation(t *testing.T) {
	...
	t.Run("displays current values and scope selector", func(t *testing.T) {
		...
		if !strings.Contains(out, "ancora") {
	...
	t.Run("shows first scope option selected", func(t *testing.T) {
		...
		m.MoveScopeCursor = 0
		m.MoveProjectList = []string{"syfra", "ancora"}
...
func TestViewObservationDetailTimelineSessionsAndSessionDetail(t *testing.T) {
	...
	m.Timeline = &store.TimelineResult{
		...
		SessionInfo:  &store.Session{ID: "session-1", Project: "ancora"},
		TotalInRange: 3,
	}
	out = m.viewTimeline()
	...
	m.Sessions = []store.SessionSummary{
		{ID: "s1", Project: "ancora", StartedAt: "2026-01-01", Summary: &summary, ObservationCount: 2},
		{ID: "s2", Project: "ancora", StartedAt: "2026-01-02", ObservationCount: 1},
		{ID: "s3", Project: "ancora", StartedAt: "2026-01-03", ObservationCount: 1},
		{ID: "s4", Project: "ancora", StartedAt: "2026-01-04", ObservationCount: 1},
		{ID: "s5", Project: "ancora", StartedAt: "2026-01-05", ObservationCount: 1},
		{ID: "s6", Project: "ancora", StartedAt: "2026-01-06", ObservationCount: 1},
		{ID: "s7", Project: "ancora", StartedAt: "2026-01-07", ObservationCount: 1},
	}
	out = m.viewSessions()
...
func TestViewRouterCoversAllScreens(t *testing.T) {
	...
	m.Sessions = []store.SessionSummary{{ID: "test", Project: "ancora", StartedAt: "now", ObservationCount: 1}}
	m.SelectedSessionIdx = 0
